...
def move():
    ...
    goal.trajectory.points[0]=JointTrajectoryPoint(positions=joints_pos, velocities=[0]*6,time_from_start=rospy.Duration(0.0))# first point
    goal.trajectory.points[1]=JointTrajectoryPoint(positions=[-1.91,-1.5,-1.8,0.13,1.23,-0.15], velocities=[0]*6,time_from_start=rospy.Duration(1.0)) #second point 
    goal.trajectory.points[2]=JointTrajectoryPoint(positions=[-1.91,-1.5,-1.7,0.13,1.23,-0.15], velocities=[0]*6,time_from_start=rospy.Duration(2.0)) #third point
    goal.trajectory.points[3]=JointTrajectoryPoint(positions=[-1.91,-1.5,-1.6,0.13,1.23,-0.15], velocities=[0]*6,time_from_start=rospy.Duration(3.0)) #furth point
    goal.trajectory.points[4]=JointTrajectoryPoint(positions=[-1.91,-1.5,-1.5,0.13,1.23,-0.15], velocities=[0]*6,time_from_start=rospy.Duration(4.0))
